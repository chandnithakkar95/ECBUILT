	          		...
	          		<div class="row">
	            		<div class="col-sm-4">
				       		<div class="logo pull-left">
		              			<a href="index.php">
		              				<img class="img-responsive" src="images/logo (2).png" data-at2x="images/logo (2).png" alt="Logo" />
								</a>
					      	</div>
                   						...
                   						<ul>
                     	 					<li >
                        						<span class="hidden-tablet">
                          							<a class="submenu" href="product.php?subcat=<?php echo $display1['Sub_Cate_ID']; ?>" id="<?php echo $tp=$display1['Sub_Cate_ID']; ?>">
