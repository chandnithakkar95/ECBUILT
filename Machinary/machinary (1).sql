...
INSERT INTO `background_image` (`back_image_ID`, `back_image`) VALUES
(1, '../user/images/image-bg.jpg');
...
INSERT INTO `quality` (`Q_id`, `prod_id`, `Q_name`, `price`) VALUES
(1, 1, 'default', 0);
...
(7, 'def', 'def', 'def', 1),
(9, 'abc', 'anc', 'image/slider/portfolio-1.jpg', 1);
...
INSERT INTO `sub_category` (`Sub_Cate_ID`, `Sub_Cate_Name`, `Sub_Cate_Status`, `Cate_ID`) VALUES
(5, 'Wrapping Machines', 1, 6);
...
--
ALTER TABLE `product_image`
  MODIFY `Prod_Image_ID` int(10) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `sub_category`
  MODIFY `Sub_Cate_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
