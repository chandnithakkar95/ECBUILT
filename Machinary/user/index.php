...
<div class="container-fluid">
	...
	<div class="row-fluid">
				...
				<td width="300px">
				<a href="profile.php" class="border-button">
					<i class="icon-user"><center></center></i>
					<p><center>Machinary</center></p>	
				</a>
				</td>
				<td width="300px">
				<a href="product.php" class="border-button">
					<i class="icon-shopping-cart"><center></center></i>
					<p><center>Exim</center></p>	
				</a>
				</td>
				<td width="300px">
				<a href="product.php" class="border-button">
					<i class="icon-shopping-cart"><center></center></i>
					<p><center>Packagings</center></p>	
				</a>
				</td>
				</tr>
				</table>
