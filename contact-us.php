...
<!-- Fonts -->	
<link href='http://fonts.googleapis.com/css?family=Open+Sans:300italic,700italic,400,300,700subset=latin,latin-ext' rel='stylesheet' type='text/css'>
...
<ul>
<li><a href="#"><i class="fa fa-fw"></i><span>C</span></a></li>
<li><a href="#"><i class="fa fa-fw"></i><span>O</span></a></li>
<li><a href="#"><i class="fa fa-fw"></i><span>M</span></a></li>
<li><a href="#"><i class="fa fa-fw"></i><span>I</span></a></li>
<li><a href="#"><i class="fa fa-fw"></i><span>N</span></a></li>
<li><a href="#"><i class="fa fa-fw"></i><span>G</span></a></li>
 
<li><a href="#"><i class="fa fa-fw"></i><span>&nbsp; </span></a></li>
<li><a href="#"><i class="fa fa-fw"></i><span>S</span></a></li>
<li><a href="#"><i class="fa fa-fw"></i><span>O</span></a></li>
<li><a href="#"><i class="fa fa-fw"></i><span>O</span></a></li>
<li><a href="#"><i class="fa fa-fw"></i><span>N</span></a></li>
...
<img class="img-responsive" src="images/logo (2).png" data-at2x="images/logo@2x.png" alt="Logo" />
</div>
</header>
<!-- /header -->
...
<h4>Feel free to ask us anytime!!</h4>
		<h4>Ask us!		</h4>
...
<ul>
<li><span>address: </span>Ahmedabad</li>
<li><span>email: </span><a href="#">info@shppl.com</a></li>

</ul>
<div id="map1"><script src='https://maps.googleapis.com/maps/api/js?v=3.exp'></script><div style='overflow:hidden;height:300px;width:450px;'><div id='gmap_canvas' style='height:440px;width:700px;'></div><div><small><a href="http://embedgooglemaps.com">embed google maps</a></small></div><div><small><a href="http://promocode.com.ph/">See the latest discount codes from some online shop in the Philippines</a></small></div><style>#gmap_canvas img{max-width:none!important;background:none!important}</style></div><script type='text/javascript'>function init_map(){var myOptions = {zoom:12,center:new google.maps.LatLng(27.6648274,-81.51575350000002),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(27.6648274,-81.51575350000002)});infowindow = new google.maps.InfoWindow({content:'<strong>SHPPL</strong><br>Opposite St.Xavier\'s Girls Hostel, Swastik Cross Rd, Vasant Vihar, Navrangpura, Ahmedabad, Gujarat 380009<br>'});google.maps.event.addListener(marker, 'click', function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script></div>
</div>
</div><!-- /maps section -->
</div><!-- /row -->
